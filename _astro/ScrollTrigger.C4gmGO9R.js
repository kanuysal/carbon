 ...
 */ var ve,
  ...
  Be = function (e, n) {
    return (
      ...
      (typeof e == "string" && ve.config().nullTargetWarn !== !1 ? console.warn("Element not found:", e) : null)
    );
  },
  yi = function (e, n) {
  ...
  ei = function (e) {
    return (
      ...
      !Gr &&
        ...
        (qn = J.isTouch =
          Ve.matchMedia && Ve.matchMedia("(hover: none), (pointer: coarse)").matches
            ? 1
            : "ontouchstart" in Ve || navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0
              ? 2
              : 0),
        (ot = J.eventTypes =
          (
  ...
  return (
    (e.init = function (t) {
      ...
      var Ct,
        ...
        vt = function () {
          ...
          (ue && (f || b) && ue(a, m, F, et, Ze),
            ...
            b &&
              ...
              (gt = a.deltaY),
              (Ze[0] = Ze[1] = Ze[2] = 0)),
            (O || ze) && (Pe && Pe(a), ze && (X && ze === 1 && X(a), W && W(a), (ze = 0)), (O = !1)),
            Xe && !(Xe = !1) && xe && xe(a),
            q && (oe(a), (q = !1)),
            (Ct = 0));
        },
        ...
        Zt = function (m, F) {
          (Me && !Ne && ((a.axis = Ne = Math.abs(m) > Math.abs(F) ? "x" : "y"), (Xe = !0)),
        ...
        Et = function (m) {
          if (!te(m, 1)) {
            ...
            ((a.x = F),
              (a.y = f),
              (C || ((b || _) && (Math.abs(a.startX - F) >= i || Math.abs(a.startY - f) >= i))) &&
      ...
      ((De = a._dc = ve.delayedCall(h || 0.25, Mr).pause()),
        ...
        (a.disable = function () {
          a.isEnabled &&
            ...
            a.isPressed && (a._vx.reset(), a._vy.reset(), Re(Q ? l : K, ot[1], Et, !0)),
 ...
 */ var d,
  ...
  zn = { startColor: "green", endColor: "red", indent: 0, fontSize: "16px", fontWeight: "normal" },
  ...
  jt = function () {
    (!Oe || !Oe.isPressed || Oe.startX > L.clientWidth) &&
      (P.cache++, Oe ? Pr || (Pr = requestAnimationFrame(yt)) : yt(), je || qt("scrollStart"), (je = Se()));
  },
  an = function () {
    ...
    (P.cache++,
      (e === !0 ||
        (!Ce &&
          ...
          (!hn || ii !== E.innerWidth || Math.abs(E.innerHeight - ni) > E.innerHeight * 0.25))) &&
        Jr.restart(!0));
  },
  Vt = {},
  Pi = [],
  ...
  Nn = function (e) {
    return Er(".gsap-marker-start, .gsap-marker-end, .gsap-marker-scroller-start, .gsap-marker-scroller-end").forEach(
      function (n) {
  ...
  yt = function (e) {
    if (e === 2 || (!Fe && !Qr)) {
      ...
      if (
        ((Vr = xn > i ? -1 : 1),
        Fe || (xn = i),
        r && (je && !tn && t - je > 200 && ((je = 0), qt("scrollEnd")), (dr = sn), (sn = t)),
        Vr < 0)
      ) {
  ...
  or = function (e) {
    if (e) {
      ...
      for ((e.t._gsap || d.core.getCache(e.t)).uncache = 1; r < t; r += 2)
        ((u = e[r + 1]), (i = e[r]), u ? (n[i] = u) : n[i] && n.removeProperty(i.replace(Ri, "-$1").toLowerCase()));
    }
  },
  Nr = function (e) {
  ...
  Hn = function (e, n, t, r, i, u, l, p, x, Y, M, h, c, v) {
    ...
    if ((c && c.seek(0), isNaN(e) || (e = +e), _r(e)))
      (c && (e = d.utils.mapRange(c.scrollTrigger.start, c.scrollTrigger.end, 0, h, e)), l && Ur(l, t, r, !0));
    else {
      ke(n) && (n = n(p));
      var ge = (e || "0").split(" "),
        k,
    ...
    if ((v && ((p[v] = e || -0.001), e < 0 && (e = 0)), u)) {
      ...
      ((X = "scroll" + r.d2),
        ...
        M && ((x = xt(l)), M && (u.style[r.op.p] = x[r.op.p] - r.op.m - u._offset + le)));
    }
    return (
      c &&
        W &&
        ((X = xt(W)), c.seek(h), (ne = xt(W)), (c._caScrollDist = X[r.p] - ne[r.p]), (e = (e / c._caScrollDist) * h)),
      c && c.seek($),
      c ? e : Math.round(e)
    );
  },
  ...
  _i = function (e, n, t) {
    ...
    return function (u) {
      var l = Math.round(e());
      return (
        l !== r && l !== i && Math.abs(l - r) > 3 && Math.abs(l - i) > 3 && ((u = l), t && t()),
        (i = r),
        (r = Math.round(u)),
        r
      );
    ...
    return (
      (e.init = function (t, r) {
        ...
        if (
          ...
          (s.vars = t),
          (r = r || t.animation),
          "refreshPriority" in t && ((ti = 1), t.refreshPriority === -9999 && (Tr = s)),
          (pt.tweenScroll = pt.tweenScroll || { top: Gn(w, ae), left: Gn(w, Le) }),
          ...
          k &&
            ...
            "scrollBehavior" in L.style && d.set(ie ? [L, Ue] : w, { scrollBehavior: "auto" }),
                  ...
                  if (
                    ...
                    (k.inertia === !1 && (Z = V - C),
                      Me(
                        H,
                        {
                          duration: tt(Qt((Math.max(Qt(we - fe), Qt(V - fe)) * 0.185) / A / 0.05 || 0)),
                          ease: k.ease || "power3",
                          data: Qt(H - f),
          ...
          c &&
            (v === !1 ||
              v === Je ||
              (v = !v && c.parentNode && c.parentNode.style && Qe(c.parentNode).display === "flex" ? !1 : re),
            (s.pin = c),
        ...
        if (
          ...
          (s.revert = function (f, b) {
            ...
            var _ = f !== !1 || !s.enabled,
              C = Ce;
            _ !== s.isReverted &&
              (_ && ((nt = Math.max(ee(), s.scroll.rec || 0)), (me = s.progress), (zt = r && r.progress())),
              Xe &&
            ...
            if (!((Ce || !s.enabled) && !b)) {
              ...
              for (
                ke(G) && (G = G(s)),
                  G = On(G, "start", s),
                  O =
                    Hn(G, h, fe, g, ee(), Xe, a, s, A, j, Ee, Z, y, s._startClamp && "_startClamp") || (c ? -0.001 : 0),
                  ke(z) && (z = z(s)),
                  $e(z) &&
                    !z.indexOf("+=") &&
                    (~z.indexOf(" ")
                      ...
                      : ((V = $r(z.substr(2), fe)),
                        (z = $e(G)
                          ? G
                          : (y ? d.utils.mapRange(0, y.duration(), y.scrollTrigger.start, y.scrollTrigger.end, O) : O) +
                            V),
                        (it = h))),
                  z = On(z, "end", s),
                  q =
              ...
              if (
                ...
                s._endClamp && !Fe && ((s._endClamp = q || -0.001), (q = Math.min(q, ct(w, g)))),
                (U = q - O || ((O -= 0.01) && 0.001)),
                we && (me = d.utils.clamp(0, 1, d.utils.normalize(O, q, nt))),
                (s._pinPush = H),
                Xe && V && ((_e = {}), (_e[g.a] = "+=" + V), We && (_e[g.p] = "-=" + ee()), d.set([Xe, Ne], _e)),
                c && !(vn && s.end >= ct(w, g)))
              )
                ((_e = Qe(c)),
                  (Dr = g === ae),
                  ...
                  !Z &&
                    ...
                    (at = { style: at, value: at["overflow" + g.a.toUpperCase()] }),
                    ie &&
                  ...
                  v
                    ? ((te = [v + g.os2, U + H + le]),
                      ...
                      he && (te.push(g.d, he + le), ce.style.flexBasis !== "auto" && (ce.style.flexBasis = he + le)),
                      or(te),
                      We &&
                      ...
                      Ee && ee(nt))
                    : ((he = jr(c, g)), he && ce.style.flexBasis !== "auto" && (ce.style.flexBasis = he + le)),
                  Ee &&
                    ((be = {
              ...
              (ur &&
                ...
                (we || me !== s.progress || y || $ || (r && !r._initted)) &&
                  (r &&
                    ...
                    r.totalProgress(y && O < -0.001 && !me ? d.utils.normalize(O, q, 0) : me, !0),
          ...
          (s.update = function (f, b, _) {
            if (!(y && !_ && !f)) {
              var C = Fe === !0 ? nt : s.scroll(),
                ...
                st;
              if (
                (b && ((ze = De), (De = y ? ee() : C), k && ((Lt = Et), (Et = r && !ue ? r.totalProgress() : A))),
                X &&
                  c &&
                  !Ce &&
                  !Fr &&
                  ...
                  it && !Ce
                    ? (ue &&
                      ...
                      Te &&
                        ...
                        (pr(s.callbackAnimation), D ? D.progress(1) : pr(r, z === "reverse" ? 1 : !A, 1)))
                    : ue && u && !Ce && u(s));
              }
              if (Kt) {
          ...
          (s.setPositions = function (f, b, _, C) {
            ...
            (s.refresh(!1, !1, { start: Yn(f, _ && !!s._startClamp), end: Yn(b, _ && !!s._endClamp) }, C), s.update());
          }),
          ...
          (s.disable = function (f, b) {
            if (
              ...
              for (var _ = T.length; _--; ) if (T[_].scroller === w && T[_] !== s) return;
          ...
          (s.kill = function (f, b) {
            ...
            (_ >= 0 && T.splice(_, 1),
              ...
              _ || Fe || (s.scroll.rec = 0),
              r && ((r.scrollTrigger = null), f && r.revert({ kill: !1 }), b || r.kill()),
              Xe &&
      ...
      (o.positionInViewport = function (t, r, i) {
        ...
        var u = t.getBoundingClientRect(),
          l = u[i ? Wt : Gt],
          p =
            r == null ? l / 2 : r in en ? en[r] * l : ~r.indexOf("%") ? (parseFloat(r) * l) / 100 : parseFloat(r) || 0;
...
var $n = function (e, n, t, r) {
  ...
  cn = function o(e, n) {
    (n === !0
      ...
      : (e.style.touchAction = n === !0 ? "auto" : n ? "pan-" + n + (J.isTouch ? " pinch-zoom" : "") : "none"),
      e === Ue && o(L, n));
  },
  Wr = { auto: 1, scroll: 1 },
  Yi = function (e) {
  ...
  Li = function (e) {
    ...
    var n = e,
      ...
      $ = 1,
      X =
        (J.isTouch && E.visualViewport ? E.visualViewport.scale * E.visualViewport.width : E.outerWidth) / E.innerWidth,
      ne = 0,
      W = ke(r)
        ? function () {
            return r(l);
    ...
    return (
        ...
        function (I, Q) {
          if ((c.offset && g(), !Q)) Ee.restart(!0);
            ...
            (t &&
              ...
              ((Mt && w.vars.scrollY >= p) || s >= p - 1) && d.to({}, { onUpdate: Pe, duration: j }));
          }
          u && u(I);
        }),
      (e.onWheel = function () {
      ...
      (e.onEnable = function () {
        (cn(x, t ? !1 : "x"),
          ...
          de(E, "resize", Pe),
          c.smooth && ((c.target.style.scrollBehavior = "auto"), (c.smooth = v.smooth = !1)),
          qe.enable());
      }),
