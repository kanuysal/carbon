...
var Y = class {
    constructor(t, i, { autoResize: e = !0, debounce: s = 250 } = {}) {
      ((this.wrapper = t),
        (this.content = i),
        e &&
          ((this.debouncedResize = X(this.resize, s)),
  ...
  x = class {
    ...
    emit(t, ...i) {
      let e = this.events[t] || [];
      for (let s = 0, o = e.length; s < o; s++) e[s]?.(...i);
    }
    on(t, i) {
      return (
  ...
  P = class {
    ...
    constructor({
      ...
      gestureOrientation: r = m === "horizontal" ? "both" : "vertical",
      touchMultiplier: a = 1,
      wheelMultiplier: d = 1,
      autoResize: v = !0,
      prevent: f,
      ...
      ((window.lenisVersion = M),
        ...
        typeof c == "number" && typeof h != "function"
          ? (h = R)
          : typeof h == "function" && typeof c != "number" && (c = 1),
        (this.options = {
          wrapper: t,
          content: i,
          eventsTarget: e,
        ...
        (this.dimensions = new Y(t, i, { autoResize: v })),
        ...
        (this.virtualScroll = new A(e, { touchMultiplier: a, wheelMultiplier: d })),
      ...
      const e = t
        ...
        .find(
          (s) =>
            ...
            (s.getAttribute("href")?.startsWith("#") ||
              s.getAttribute("href")?.startsWith("/#") ||
              s.getAttribute("href")?.startsWith("./#")),
        );
      if (e) {
        ...
        if (s) {
          ...
          let l = `#${s.split("#")[1]}`;
          (["#", "/#", "./#", "#top", "/#top", "./#top"].includes(s) && (l = 0), this.scrollTo(l, o));
        }
      }
    };
    onPointerDown = (t) => {
    ...
    onVirtualScroll = (t) => {
      ...
      if (
        (this.emitter.emit("virtual-scroll", { deltaX: i, deltaY: e, event: s }), s.ctrlKey || s.lenisStopPropagation)
      )
        return;
        ...
        p.find(
          (f) =>
            ...
            ((typeof u == "function" && u?.(f)) ||
              ...
              (o && f.hasAttribute?.("data-lenis-prevent-touch")) ||
              (l && f.hasAttribute?.("data-lenis-prevent-wheel")) ||
              (this.options.allowNestedScroll && this.checkNestedScroll(f, { deltaX: i, deltaY: e }))),
        )
      )
        return;
      ...
      if (!((this.isStopped || this.isLocked) && !p)) {
        ...
        if (typeof t == "number") {
          ...
          (u || (this.targetScroll = t),
            typeof o == "number" && typeof l != "function"
              ? (l = R)
              : typeof l == "function" && typeof o != "number" && (o = 1),
            this.animate.fromTo(this.animatedScroll, t, {
              duration: o,
              easing: l,
              lerp: n,
              onStart: () => {
                (s && (this.isLocked = !0), (this.isScrolling = "smooth"), c?.(this));
              },
              onUpdate: (r, a) => {
    ...
    checkNestedScroll(t, { deltaX: i, deltaY: e }) {
      ...
      if (s - (o.time ?? 0) > 2e3) {
        ...
        ((c = o.isScrollableX),
          ...
          (m = o.clientWidth),
          (r = o.clientHeight));
      if ((!l && !n) || (!c && !h) || (a === "vertical" && (!n || !h)) || (a === "horizontal" && (!l || !c))) return !1;
      let d;
      if (a === "horizontal") d = "x";
      else if (a === "vertical") d = "y";
      else {
        const w = i !== 0,
          T = e !== 0;
        (w && l && c && (d = "x"), T && n && h && (d = "y"));
      ...
      if (!d) return !1;
      let v, f, g, y, E;
      if (d === "x") ((v = t.scrollLeft), (f = p - m), (g = i), (y = l), (E = c));
      else if (d === "y") ((v = t.scrollTop), (f = u - r), (g = e), (y = n), (E = h));
      else return !1;
...
class F {
  ...
  init() {
    this.lenis = new P({
      duration: window.innerWidth > 768 ? 0.6 : 1,
